...
ll.loaded=[];ll.check=function(){var elements=document.getElementsByClassName(ll.class);var element=elements[0];var page=window.pageYOffset+window.innerHeight;var offsetTop=element.offsetTop;if(page>offsetTop){if(ll.onBeforeShow){ll.onBeforeShow(element);}
...
ll.loaded=[];}
ll.init=function(){window.onload=function(){ll.firstLoad();if(ll.debug){console.log('LazyLoad:',ll);}
